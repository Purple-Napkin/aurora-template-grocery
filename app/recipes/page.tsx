          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {recipesWithProducts.map((r) => (
              <Link
                ...
                className={`group flex flex-col overflow-hidden rounded-xl bg-white dark:bg-white ${CONTENT_BLOCK_CARD_SHELL}`}
              >
                ...
                <div className="px-3 sm:px-4 py-3 border-t border-stone-200/90">
