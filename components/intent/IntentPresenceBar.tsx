...
export function IntentPresenceBar() {
  ...
  return (
    <div
      className="relative z-[100] w-full border-b border-emerald-900/30 bg-[#14532d] text-emerald-50 shadow-sm"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 sm:py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          <div className="relative" ref={whyRef}>
            ...
            {whyOpen && (
              <div className="absolute right-0 top-full z-[110] mt-1 w-[min(100vw-2rem,24rem)] rounded-xl border border-emerald-800 bg-[#0f3d24] p-3 text-xs text-emerald-100 shadow-xl whitespace-pre-line leading-relaxed">
                {whyExplanation}
              </div>
            )}
          </div>
